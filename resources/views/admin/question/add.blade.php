                            ...
                            <form action="{{ route('question.create', $survey->id) }}" method="post">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="question_content" id="question_content" cols="30" rows="5" placeholder="Nội dung câu hỏi"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="question_category" id="question_category" cols="30" rows="5" placeholder="Danh mục câu hỏi"></textarea>
